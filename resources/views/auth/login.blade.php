	...
	<body>
		<section>
			<div class="flex justify-center items-center h-dvh">
				<form action="{{ route('session.store') }}" class="border rounded border-gray-300 w-full lg:w-4/12 p-3" method="POST">
					@csrf
					<div>
					...
					<div>
						...
						<div class="flex justify-center">
							<span class="text-sm inline-block">Dont have an account? <a href="{{ route('register') }}" class="hover:text-blue-600 text-blue-400">Register here</a> </span>
						</div>
					</div>
				</form>
			</div>
