...
@section('main-content')
    <div class="bg-linear-to-br from-[#1f2937] via-[#2d3748] to-[#c2410c] text-gray-50 h-screen w-full px-5 xl:px-0">
        ...
        <div class="flex justify-center items-center h-screen"">
            <form class="border bg-[#142536] flex flex-col gap-4 rounded  text-gray-200 w-full md:w-5/12  lg:w-3/12 p-5"
                ...
                <div><button class="block my-3 w-full rounded py-1 px-3 bg-[#f54c00] hover:bg-[#c75723] text-white cursor-pointer"
